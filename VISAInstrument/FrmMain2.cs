...
namespace VISAInstrument
{
    ...
    public partial class FrmMain2 : MaterialForm
    {
        //端口开关委托
        ...
        public static FrmMain2 form_st=null;
        public FrmMain2()
        {
            InitializeComponent();
            form_st = this;
        ...
        private void btnOpen_Click(object sender, EventArgs e)
        {
            if (btnOpen.Text == Resources.OpenString)
            {
                try
                {
                    ...
                    //判断是否为信号发生器
                    if (Device_ID.Contains("DMM6500"))
                    {
                        isopen = true;
                    }
                    else
                    {
                        MessageBox.Show("貌似不是数字万用表！");
            ...
            open_change_event.Invoke("数字万用表",isopen);
        }
        ...
        private void FrmMain_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            MainForm.wave_frmMain2.Visible = false;
            e.Cancel = true;
            return;
