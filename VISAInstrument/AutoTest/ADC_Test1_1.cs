...
{
    public partial class DAC_Test1_1 : MaterialForm
    {
        ...
        public DAC_Test1_1(bool wenxiang,bool wenyayuan)
        {
        ...
        private void auto_test_button_Click(object sender, EventArgs e)
        {
            ...
            if (vol_check.Checked == true)
            {
                ...
                Play_LOG("正在执行电压校准");
                if (Voltage_calibration.Vol_list(dianyas, ref VOL_LIST))
                {
        ...
        public void one_test()
        {
                ...
                if (wenxiang.set_wendu(set_wendu_str) == true)
                {
                    while (true)
                    {
                        ...
                        if (get_wendu_str != "NULL")
                        {
                            ...
                            if (Math.Abs(Convert.ToInt32(get_wendu_str, 10) - Convert.ToInt32(set_wendu_str, 10)) <= 20)
                            {
                                break;
                            }
                        }
            ...
            if (Auto_One.DAC_MIN != Auto_One.DAC_MAX)
            {
                ...
                if (Auto_One.DAC == "DAC1")
                {
                    ...
                    DAC_config.Add(Auto_One.MIX ? "dac enable all" :"dac init channel1");
                    //设置初始DAC
                    ...
                    Excel.ADD_ONE_EXCEL(file_name, Auto_One.DAC + "_" + Auto_One.wendu + "°C" + "(线性度测试)",
                ...
                else if (Auto_One.DAC == "DAC2")
                {
                    ...
                    DAC_config.Add(Auto_One.MIX ? "dac enable all" :"dac init channel2");
                    //设置初始DAC
            ...
            else
            {
                ...
                if (Auto_One.DAC == "DAC1")
                {
                    ...
                    Excel.ADD_ONE_EXCEL(file_name, Auto_One.DAC + "_" + Auto_One.wendu + "°C"+"(单点测试)",
                        "VOLT:" + Auto_One.volt + "V  BUFF:" + (Auto_One.buff ? "ON" : "OFF") + (Auto_One.MIX ? "  MIX" : "  NOMIX"),
                        dac_set, dac_shoud, dac_get);
